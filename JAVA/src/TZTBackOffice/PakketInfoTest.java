...
public class PakketInfoTest {
    ...
    public static void main(String[] args) {
        ...
        AccountHouder klant = new AccountHouder("Piet", "Piet@gmail.com", "03342023423", 1, "Pietersen", locatie);
        LocalDate localDateTime = LocalDate.now();
        VerzendOrder verzendOrder = new VerzendOrder(klant, new Timestamp(1));
